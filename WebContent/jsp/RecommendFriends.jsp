...
<%
		...
		lstFriends = (ArrayList<Friends>) friendDao.selectByUid(me.getUid());
	%>			
...
<div style="width:100%; height:20px; margin-top:20px;"><a href="javascript:FindFriendByCity('<%= me.getCity()%>');">&nbsp;推荐给我身边的宠友</a></div>
...
<div style="float:left; width:100px; height:150px; margin:5px;">
 <div style="height:100px; width:100px; text-align:center;"><img src="/PetHotel/upload/images/photo/${friend.headportrait }" width="100px" height="100px"></div>
 <div style="height:25px; width:100px;text-align:center;">${friend.uname}</div>
 <div style="height:25px; width:100px;text-align:center;"><label><input type="button" name="button3" id="button3" onClick="javascript:AddFriendById('<%= me.getUid()%>','${friend.uid }');"value="添加好友"></label></div>
</div>
</c:if>
</c:forEach> 
</div>
