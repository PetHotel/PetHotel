	  ...
	  <div id="mainMenu">
		...
		<div class="mask">
			<div class="pmenu"><!--个人主页菜单-->
				<div id="blogHomeDiv">
					<a href="/PetHotel/ShowOtherUserServlet?uid=${requestScope.users.uid }" class="blogHome"></a>
				</div>
				<div id="blogPetsDiv">
					<a href="/PetHotel/FindAllPetsByUidServlet?uid=${requestScope.users.uid }&choice=1" class="blogPets"></a>
				</div>
 ...
 <hr/>
  <table width="510" height="377" border="0">
   <tr>
     ...
     <td height="54" colspan="3" align="center">Ta的信息：</td>
     </tr>
   <tr>
     <td align="left"><img src="images/man.JPG" width="18" height="18">Ta的萌称:</td>
     <td height="58" colspan="2" align="left">${requestScope.users.uname}</td>
   </tr>
   <tr>
     <td align="left"><img src="images/home.JPG" width="20" height="20">Ta的小窝:</td>
     <td height="49" colspan="2" align="left">${requestScope.users.province},${requestScope.users.city},${requestScope.users.district}</td>
   </tr>
   <tr>
     <td align="left"><img src="images/qq.JPG" width="21" height="18">Ta的QQ:</td>
     <td height="44" colspan="2" align="left">${requestScope.users.qq}</td>
   </tr>
   <tr>
     <td width="124" height="42" align="left"><img src="images/reputation.JPG" width="18" height="18">Ta的人气:</td>
     <td width="227" colspan="2" align="left">${requestScope.users.reputation}</td>
   </tr>
   </table>
   <hr/>
</div>
