...
<form id="formInner" name="formInner" method="post" action="/PetHotel/ApplyServlet">
	  <table   width="779" style="margin-left:108px;"><!-- height="558" -->
                    <tr height="50" >
                      <td colspan="2" align="center" ><strong style="font-size:20px;"> &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;&nbsp;分享内容</strong><br/></td>
                    </tr>
                    <tr height="30">
                      ...
                      <c:if test="${requestScope.posts.uid == sessionScope.user.uid }">       <!-- Current ID -->
